...
pub fn getGlobalApplicationCommands(client: *rest.ApiClient, application_id: Snowflake, with_localizations: ?bool) !rest.Client.Result([]ApplicationCommand) {
...
pub fn createGlobalApplicationCommand(client: *rest.ApiClient, application_id: Snowflake, body: CreateGlobalApplicationCommandBody) !rest.Client.Result(ApplicationCommand) {
...
pub fn getGlobalApplicationCommand(client: *rest.ApiClient, application_id: Snowflake, command_id: Snowflake) !rest.Client.Result(ApplicationCommand) {
...
pub fn editGlobalApplicationCommand(client: *rest.ApiClient, application_id: Snowflake, command_id: Snowflake, body: EditGlobalApplicationCommandBody) !rest.Client.Result(ApplicationCommand) {
    const uri_str = try rest.allocDiscordUriStr(client.rest_client.allocator, "/applications/{d}/commands/{d}", .{ application_id, command_id });
    defer client.rest_client.allocator.free(uri_str);
    const uri = try std.Uri.parse(uri_str);
...
pub fn deleteGlobalApplicationCommand(client: *rest.ApiClient, application_id: Snowflake, command_id: Snowflake) !rest.Client.Result(void) {
    const uri_str = try rest.allocDiscordUriStr(client.rest_client.allocator, "/applications/{d}/commands/{d}", .{ application_id, command_id });
    defer client.rest_client.allocator.free(uri_str);
    const uri = try std.Uri.parse(uri_str);
...
pub fn bulkOverwriteGlobalApplicationCommands(client: *rest.ApiClient, application_id: Snowflake, new_commands: []const ApplicationCommand) !rest.Client.Result([]ApplicationCommand) {
    const uri_str = try rest.allocDiscordUriStr(client.rest_client.allocator, "/applications/{d}/commands/", .{application_id});
    defer client.rest_client.allocator.free(uri_str);
    const uri = try std.Uri.parse(uri_str);
...
pub fn getGuildApplicationCommands(client: *rest.ApiClient, application_id: Snowflake, guild_id: Snowflake, with_localizations: ?bool) !rest.Client.Result([]ApplicationCommand) {
    const query = WithLocalizationsQuery{ .with_localizations = with_localizations };
...
pub fn createGuildApplicationCommand(client: *rest.ApiClient, application_id: Snowflake, guild_id: Snowflake, body: CreateGuildApplicationCommandBody) !rest.Client.Result(ApplicationCommand) {
...
pub fn getGuildApplicationCommand(client: *rest.ApiClient, application_id: Snowflake, guild_id: Snowflake, command_id: Snowflake) !rest.Client.Result(ApplicationCommand) {
...
pub fn editGuildApplicationCommand(client: *rest.ApiClient, application_id: Snowflake, guild_id: Snowflake, command_id: Snowflake, body: EditGuildApplicationCommandBody) !rest.Client.Result(ApplicationCommand) {
    const uri_str = try rest.allocDiscordUriStr(client.rest_client.allocator, "/applications/{d}/guilds/{d}/commands/{d}", .{ application_id, guild_id, command_id });
    defer client.rest_client.allocator.free(uri_str);
    const uri = try std.Uri.parse(uri_str);
...
) !rest.Client.Result(ApplicationCommand) {
    const uri_str = try rest.allocDiscordUriStr(client.rest_client.allocator, "/applications/{d}/guilds/{d}/commands/{d}", .{ application_id, guild_id, command_id });
    defer client.rest_client.allocator.free(uri_str);
    const uri = try std.Uri.parse(uri_str);
...
) !rest.Client.Result([]const ApplicationCommand) {
    const uri_str = try rest.allocDiscordUriStr(client.rest_client.allocator, "/applications/{d}/guilds/{d}/commands", .{ application_id, guild_id });
    defer client.rest_client.allocator.free(uri_str);
    const uri = try std.Uri.parse(uri_str);
...
pub fn getGuildApplicationCommandPermissions(
    ...
    application_id: Snowflake,
    guild_id: Snowflake,
) !rest.Client.Result([]const model.interaction.command.GuildApplicationCommandPermissions) {
...
pub fn getApplicationCommandPermissions(
    ...
    guild_id: Snowflake,
    command_id: Snowflake,
) !rest.Client.Result(model.interaction.command.ApplicationCommandPermission) {
